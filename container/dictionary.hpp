...
public:
  ...
  // Copy assignment
  bool operator=(const DictionaryContainer&) =delete; // Copy assignment of abstract types is not possible.

  // Move assignment
  bool operator=(DictionaryContainer&&) noexcept =delete; // Move assignment of abstract types is not possible.

  /* ************************************************************************ */

  // Comparison operators
  bool operator==(const DictionaryContainer&) =delete; // Comparison of abstract types is not possible.
  bool operator!=(DictionaryContainer&&) noexcept =delete; // Comparison of abstract types is not possible.
...
public:
  ...
  // Copy assignment
  bool operator=(const OrderedDictionaryContainer&)=delete; // Copy assignment of abstract types is not possible.

  // Move assignment
  bool operator=(OrderedDictionaryContainer&&) noexcept=delete; // Move assignment of abstract types is not possible.
